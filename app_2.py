...
#        return render_template("nbp_calc.html", options=options)
    ...
    if request.method == "POST":
        ...
        return render_template("nbp_calc.html", items=currency_list, b=bid_value, p=result)
    return render_template("nbp_calc.html", items=currency_list)
...
#with open("currency.csv", "r", encoding="UTF8", newline="") as csvfile:
#    parameters_list = csv.DictReader(csvfile, delimiter=";", fieldnames=parameters_list)
#    x = 0
